...
export default class LogIn extends Component {
    ...
    buscarUsuario(){
        if(this.state.correo){
            ...
            .catch(e => {
                this.openModal("No existe usuario registrado con ese correo.");
            })
        }
        else{
            this.openModal("Debes rellenar todos los campos.");
        }
    }

    render() {
        const { nombre, isOpen, mensaje } = this.state;
                                            ...
                                            <Col>
                                                ...
                                                <Modal show={this.state.isOpen}>
                                                    <Modal.Header closeButton>
                                                        <Modal.Title>Error al entrar</Modal.Title>
                                                    </Modal.Header>
