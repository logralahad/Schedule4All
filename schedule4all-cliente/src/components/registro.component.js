...
import { Image, Alert, Button, Col, Container, Row, Modal } from 'react-bootstrap';
...
export default class Registro extends Component {
    ...
    saveUsuario(){
        ...
        if(this.state.nombre && this.state.paterno && this.state.materno && this.state.fecha && 
            this.state.correo && this.state.password && this.state.genero && this.state.pais){
                ...
                UserService.create(data)
                    ...
                    .catch(e => {
                        console.log(e);
                        this.openModal("Hubo un error en la solicitud.");
                    });
        }
        else{
            this.openModal("No puedes dejar campos vacios.");
        }
    ...
    openModal = (mensaje) => this.setState({ isOpen: true, mensaje: mensaje });
    ...
    render() {
        ...
        const { isOpen, mensaje} = this.state;
